...
const slides = [
    ...
    <img width="50" src="img/logo/girl.svg" alt="Girl pray">
    <p>$35 / session</p>
    ...
    <img width="50" src="img/logo/lotus.svg" alt="Lotus">
    <p>$65 / session</p>
    ...
    <img width="50" src="img/logo/girl-leg.svg" alt="Girl with leg">
    <p>$350 / package</p>
    ...
    `<nav class="multi-level-group-classes">
    <h3>Multi-level group classes</h3>
    <img width="50" src="img/logo/girl-barbell.svg" alt="Girl with barbell">
    <p>$30 / session</p>
    ...
    `<nav class="classes-for-beginners">
    <h3>One-on-one classes for beginners</h3>
    <img width="50" src="img/logo/clock.svg" alt="Clock">
    <p>$60 / session</p>
    ...
    <h3>12-classes package for any level </h3>
    <img width="50" src="img/logo/waistline.svg" alt="Waistline">
    <p>$300 / month</p>
    <p>2 group sessions per week<br>
        1 individual training per week<br>
        Personalized nutrition plan</p>
    ...
    <img width="50" src="img/logo/pregnant.svg" alt="Pregnant">
    <p>$50 / session</p>
    ...
    <img width="50" src="img/logo/heart.svg" alt="Heart">
    <p>$65 / session</p>
    ...
    <img width="50" src="img/logo/dumbbells.svg" alt="Dumbbells">
    <p>$450 / month</p>
    ...
    <img width="50" src="img/logo/boy.svg" alt="Boy">
    <p>$20 / session</p>
    ...
    <img width="50" src="img/logo/book.svg" alt="Book">
    <p>$30 / session</p>
    ...
    <img width="50" src="img/logo/skipping-rope.svg" alt="Skipping rope">
    <p>$250 / month</p>
    <p>Weight routine<br>
    ...
    <img width="50" src="img/logo/old-man.svg" alt="Old man">
    <p>$30 / session</p>
    ...
    <img width="50" src="img/logo/expander.svg" alt="Expander">
    <p>$50 / session</p>
    ...
    <img width="50" src="img/logo/man-stay-on-hand-and-leg.svg" alt="Man stay on hand and leg">
    <p>$350 / month</p>
    <p>Two classes per week<br>
        Your trainer is always in touch<br>
